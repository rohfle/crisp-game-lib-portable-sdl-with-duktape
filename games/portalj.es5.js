...
function update() {
  ...
  var scrX = (playerX > 30 ? (playerX - 30) * 0.1 : 0) + difficulty * 0.1;
  color("light_black");
  ...
  if (nextFloorDist < 0) {
    var itv = rnd(50, 99);
    var fr = rnd(0.4, 0.7);
    var vx = rnd() > 1 / difficulty ? rnds(1, difficulty) * 0.25 : 0;
    floors.push({
  ...
  color("red");
  var c = box(playerX, py, 5).isColliding.rect;
  color("purple");
  box(portalX, 43, 7, 5);
