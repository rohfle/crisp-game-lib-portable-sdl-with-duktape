...
function update() {
  ...
  if ((mountainAppDist -= difficulty) < 0) {
    ...
    m.y = landingIndex > 7 || landingIndex === 1 ? rnd(70, 90) : landingIndex === 0 ? landY = rnd(40, 70) : rnd(40, 90);
    landingIndex--;
    if (landingIndex < 0) {
      m.c = "cyan";
      landingIndex = 9;
