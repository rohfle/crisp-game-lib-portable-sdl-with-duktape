...
function update() {
  ...
  remove(balls, function (b) {
    ...
    balls.forEach(function (ob) {
      ...
      var d = b.pos.distanceTo(ob.pos) - b.radius - ob.radius;
      if (d < 0) {
        b.vel.addWithAngle(ob.pos.angleTo(b.pos), -d / b.radius);
      }
    });
    if (b.pos.x < b.radius && b.vel.x < 0 || b.pos.x > 99 - b.radius && b.vel.x > 0) {
      b.vel.x *= -0.7;
    }
