...
function update() {
  ...
  sight.vel.x += wrap((sightEnemy == null ? 50 : sightEnemy.pos.x) - sight.pos.x, -50, 50) * 0.01;
  sight.vel.y += ((sightEnemy == null ? 50 : sightEnemy.pos.y) - sight.pos.y) * 0.01;
  sight.vel.mul(0.97);
